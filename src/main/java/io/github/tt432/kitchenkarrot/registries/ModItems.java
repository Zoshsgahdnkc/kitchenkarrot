...
public class ModItems {
    ...
    public static final RegistryObject<Item> BIRCH_SAP_CHOCOLATE_BAR = ITEMS.register("birch_sap_chocolate_bar", () -> new ModFood(5, 9.2F, EffectEntry.of(MobEffects.MOVEMENT_SPEED, 90, 2, 1)));
    ...
    public static final RegistryObject<Item> GRILLED_FISH_AND_CACTUS = ITEMS.register("grilled_fish_and_cactus", () -> new ModFood(8, 8F, EffectEntry.of(ModEffects.TOXIC_RESISTANCE.get(), 180, 1)));
    ...
    public static final RegistryObject<Item> MONSTER_LASAGNA = ITEMS.register("monster_lasagna", () -> new ModFood(13, 3.2F));
    public static final RegistryObject<Item> SMALL_MONSTER_LASAGNA = ITEMS.register("small_monster_lasagna", () -> new ModFood(5, 1.6F));
    ...
    public static final RegistryObject<Item> FEAST_PIZZA_SLICE = ITEMS.register("feast_pizza_slice", () -> new ModFood(8, 9.6F));
    ...
    public static final RegistryObject<Item> SASHIMI = ITEMS.register("sashimi", () -> new ModFood(4, 2.4F, EffectEntry.of(ModEffects.TOXIC_RESISTANCE.get(), 60, 1)));
    ...
    public static final RegistryObject<Item> FRIES = ITEMS.register("fries", () -> new ModFood(6, 8.4F));
    public static final RegistryObject<Item> DRUMSTICK = ITEMS.register("drumstick", () -> new ModFood(6, 8.4F, EffectEntry.of(MobEffects.DAMAGE_BOOST, 30, 1)));
    public static final RegistryObject<Item> FRIED_CHICKEN_COMBO = ITEMS.register("fried_chicken_combo", () -> new ModFood(15, 30, EffectEntry.of(MobEffects.DAMAGE_BOOST, 180, 1)));
    ...
    public static final RegistryObject<Item> BIKINI_BOTTOM_SUB = ITEMS.register("bikini_bottom_sub", () -> new ModFood(13, 14.4F, EffectEntry.of(MobEffects.DOLPHINS_GRACE, 180, 1), EffectEntry.of(ModEffects.TOXIC_RESISTANCE.get(), 180, 1)));
    ...
    public static final RegistryObject<Item> BUCHE_DE_NOEL = ITEMS.register("buche_de_noel", () -> new ModFood(5, 8F));

    // Drinks
    public static final RegistryObject<Item> SOOTHING_TEA = ITEMS.register("soothing_tea", () -> ModFood.drinkItem(1, 3.6F, EffectEntry.of(ModEffects.DISPERSE.get(), 180, 3, 3)).setDuration(ModFood.Duration.Slow));
    public static final RegistryObject<Item> BIRCH_SAP = ITEMS.register("birch_sap", () -> ModFood.drinkItem(1,2f));
    public static final RegistryObject<Item> ICED_MELON_LAGER = ITEMS.register("iced_melon_lager", () -> ModFood.drinkItem(3, 2.4F, EffectEntry.of(MobEffects.FIRE_RESISTANCE, 300, 1, 1), EffectEntry.of(ModEffects.TIPSY.get(), 180, 1)));
    public static final RegistryObject<Item> GLOW_BERRY_LAGER = ITEMS.register("glow_berry_lager", () -> ModFood.drinkItem(2, 2.4F, EffectEntry.of(MobEffects.GLOWING, 300, 1, 1), EffectEntry.of(ModEffects.TIPSY.get(), 180, 1)));
    public static final RegistryObject<Item> ACORN_WINE = ITEMS.register("acorn_wine", () -> ModFood.drinkItem(1, 0F, EffectEntry.of(ModEffects.DISPERSE.get(), 60, 2, 1)));
    public static final RegistryObject<Item> MEAD = ITEMS.register("mead", () -> ModFood.drinkItem(2, 5.2F));
    public static final RegistryObject<Item> RUM = ITEMS.register("rum", () -> ModFood.drinkItem(1, 0F, EffectEntry.of(MobEffects.DOLPHINS_GRACE, 180, 1), EffectEntry.of(ModEffects.TIPSY.get(), 180, 1)));
    public static final RegistryObject<Item> VODKA = ITEMS.register("vodka", () -> ModFood.drinkItem(1, 0F, EffectEntry.of(MobEffects.DAMAGE_BOOST, 180, 1), EffectEntry.of(ModEffects.TIPSY.get(), 180, 1)));
    ...
    // Snack Drinks
    public static final RegistryObject<Item> LIGHT_SODA = ITEMS.register("light_soda", () -> ModFood.drinkItem(1, 0, EffectEntry.of(ModEffects.DISPERSE.get(), 15, 1)).setDuration(ModFood.Duration.Fast));
    ...
    public static final RegistryObject<Item> DRAGON_BREATH_COKE = ITEMS.register("dragon_breath_coke", () -> CannedFoodItem.drinkItem(1, 3F, EffectEntry.of(MobEffects.MOVEMENT_SPEED, 360, 2, 1), EffectEntry.of(MobEffects.DIG_SPEED, 360, 2, 1)).setDuration(ModFood.Duration.Fast));

    // Food with container
    public static final RegistryObject<Item> FISHERMENS_DELIGHT = ITEMS.register("fishermens_delight", () -> new ModFood(10, 10.4F, 16, EffectEntry.of(MobEffects.LUCK, 300, 1)).setBowlFood());
    public static final RegistryObject<Item> LUSH_SALAD = ITEMS.register("lush_salad", () -> new ModFood(7, 6.4F, 16, EffectEntry.of(MobEffects.REGENERATION, 10, 1)).setBowlFood());
    public static final RegistryObject<Item> FRESH_SALAD = ITEMS.register("fresh_salad", () -> new ModFood(6, 4, 16, EffectEntry.of(MobEffects.REGENERATION, 10, 1)).setBowlFood());
    public static final RegistryObject<Item> TRAVELERS_SALAD = ITEMS.register("travelers_salad", () -> new ModFood(5, 3.2F, 16, EffectEntry.of(MobEffects.REGENERATION, 10, 1)).setBowlFood());
    ...
    public static final RegistryObject<Item> CURRY_UDON = ITEMS.register("curry_udon", () -> new ModFood(FoodUtil.effectFood(defaultProperties(), 18, 16F, false, EffectEntry.of(MobEffects.REGENERATION, 60, 1, 1)).stacksTo(1).rarity(Rarity.RARE)).setEffectEntries(new EffectEntry[]{EffectEntry.of(MobEffects.REGENERATION, 60, 0, 1)}));
